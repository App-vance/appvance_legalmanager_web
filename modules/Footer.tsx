  ...
  return (
    <>
      <footer className="font-quicksand">
        <div className="flex flex-col px-8 md:px-20 xl:px-56 py-10 bg-primary-blue text-white xl:flex-row lg:py-20">
          ...
          <div className="flex-1 w-full lg:mt-10">
            <div className="w-full h-[21.25rem] lg:h-96 lg:w-[37.125rem] xl:ml-auto">
              <iframe
                width="100%"
                height="100%"
