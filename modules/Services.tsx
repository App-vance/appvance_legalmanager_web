...
export default function Services() {
  return (
    <>
      <section className="flex flex-col lg:px-56 lg:py-20">
        ...
        <div className="flex flex-col gap-8 px-8 py-10 md:px-36 lg:grid lg:grid-cols-2 lg:px-1 lg:gap-16 custom-scrollbar">
          <CardService
            ...
            icon={<BriefcaseIcon className="h-8 w-8 stroke-2 mb-4 mx-auto text-primary-blue lg:ml-0 lg:h-12 lg:w-12" />}
            items={[
              "Área operativa",
          ...
          <CardService
            ...
            icon={<DocumentTextIcon className="h-8 w-8 stroke-2 mb-4 mx-auto text-primary-blue lg:ml-0 lg:h-12 lg:w-12" />}
            items={[
              "Derecho comercial",
          ...
          <CardService
            ...
            icon={<CurrencyDollarIcon className="h-8 w-8 stroke-2 mb-4 mx-auto text-primary-blue lg:ml-0 lg:h-12 lg:w-12" />}
            items={[
          ...
          <CardService
            ...
            icon={<Squares2X2Icon className="h-8 w-8 stroke-2 mb-4 mx-auto text-primary-blue lg:ml-0 lg:h-12 lg:w-12" />}
            items={[
