  ...
  return (
    <>
      <section className="flex flex-col lg:p-20 xl:px-56 xl:py-20">
        ...
        <div className="flex flex-col gap-8 px-8 py-10 md:px-36 lg:grid lg:grid-cols-2 lg:px-0 lg:gap-6 xl:gap-16 custom-scrollbar">
          <CardService
            id="admin"
            title="Área Administrativa"
            description="Los enfoques están dados por nuestras diferentes áreas de gestión tales como:"
            customClass="lg:grid-cols-2"
            icon={<BriefcaseIcon className="h-8 w-8 stroke-2 mb-4 mx-auto text-primary-blue lg:ml-0 xl:h-12 xl:w-12" />}
            items={[
              "Área operativa",
          ...
          <CardService
            ...
            icon={<DocumentTextIcon className="h-8 w-8 stroke-2 mb-4 mx-auto text-primary-blue lg:ml-0 xl:h-12 xl:w-12" />}
            items={[
              "Derecho comercial",
          ...
          <CardService
            ...
            icon={<CurrencyDollarIcon className="h-8 w-8 stroke-2 mb-4 mx-auto text-primary-blue lg:ml-0 xl:h-12 xl:w-12" />}
            items={[
          ...
          <CardService
            ...
            icon={<Squares2X2Icon className="h-8 w-8 stroke-2 mb-4 mx-auto text-primary-blue lg:ml-0 xl:h-12 xl:w-12" />}
            items={[
