                    ...
                    <div className="w-full mx-auto space-y-4 font-quicksand">
                        {
                            gestion?.map((item, index) => (
                                <div key={index} className="rounded-lg ring ring-[#D9D9D9] overflow-hidden">
                                    ...
                                    <label htmlFor={item.id} className="flex items-center justify-between py-4 px-6 bg-[#f9f8f8] text-secondary-blue text-features cursor-pointer">
                                        <span className="text-features text-secondary-blue">{item.title}</span>
                                    ...
                                    <div className="max-h-0 overflow-hidden transition-all ease-in-out duration-1000 peer-checked:max-h-screen">
                                        <div className="p-4">
                                            <p className="text-body text-primary-blue leading-relaxed">{item.description}</p>
                                        </div>
                                    </div>
                                </div>
                            ))
