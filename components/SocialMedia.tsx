    ...
    <>
      <div className="hidden group lg:block fixed top-1/2 -translate-y-1/2 right-0">
        <div className="relative">
          ...
          <div className="rounded-lg cursor-pointer absolute inset-0 flex items-center justify-center opacity-0 transition-all duration-300 group-hover:opacity-100 transform group-hover:-translate-x-10 group-hover:translate-y-24 group-hover:translate-z-0 bg-secondary-blue w-fit h-fit p-1">
            <Link href="https://www.linkedin.com/company/consultor%C3%ADasph/" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" fill="#0A66C2" viewBox="0 0 256 256" width="40" height="40">
                <path d="M218.123 218.123h-37.4v-59.13c0-14.1-.252-32.27-19.65-32.27-19.678 0-22.68 15.38-22.68 31.26v60.14h-37.4V95.94h35.9v16.65h.51c5-9.48 17.2-19.48 35.4-19.48 37.8 0 44.8 24.9 44.8 57.27v67.75ZM56.64 79.29c-12.03 0-21.76-9.75-21.76-21.77 0-12.03 9.73-21.78 21.76-21.78s21.76 9.75 21.76 21.78c0 12.02-9.73 21.77-21.76 21.77Zm18.7 138.83H37.94V95.94h37.4v122.18ZM237.12 0H18.88C8.47 0 0 8.47 0 18.88v218.24C0 247.53 8.47 256 18.88 256h218.24c10.41 0 18.88-8.47 18.88-18.88V18.88C256 8.47 247.53 0 237.12 0Z" fill="#fff" />
              </svg>
            </Link>
          </div>
          <div className="rounded-lg cursor-pointer absolute inset-0 flex items-center justify-center opacity-0 transition-all duration-300 group-hover:opacity-100 transform group-hover:-translate-x-24 group-hover:translate-y-8 group-hover:translate-z-0 bg-secondary-blue w-fit h-fit p-1">
            <Link href="https://x.com/consultoriasph" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" fill="#fff" viewBox="0 0 256 256" width="36" height="36">
          ...
          <div className="rounded-lg cursor-pointer absolute inset-0 flex items-center justify-center opacity-0 transition-all duration-300 group-hover:opacity-100 transform group-hover:-translate-x-10 group-hover:-translate-y-24 group-hover:translate-z-0 bg-secondary-blue w-fit h-fit p-1">
            <Link href="https://api.whatsapp.com/send?phone=573145900228&text=Me%20interesa%20contar%20con%20sus%20servicios" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" fill="#fff" viewBox="0 0 256 256" width="40" height="40">
